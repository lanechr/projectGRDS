...
if ($stmt = $link->prepare("SELECT DAID, OldDAID, Reason FROM Changes WHERE ChangeID=?")){
...
<html xmlns='http://www.w3.org/1999/xhtml'>
 <head>
  ...
  <title>Notify Changes Superceded Email</title>
 ...
 <tr bgcolor='#2a80b2' style='padding: 0px 0px 0px 0px'>
  <td style='padding: 0px 50px 0px 50px; color: #484847; font-size: 12pt'>
    <table bgcolor='#f3f8fa' border='0' cellpadding='0' cellspacing='0' width='100%'>
      ...
      <tr>
        <td align='center' style='padding: 10px 100px 10px 100px; color: #979da2; font-size: 14px'> The disposal authorisation for a record class you previously bookmarked has been superceded.
        </td>
      </tr>
      <tr>
        <td align='center' style='padding: 10px 100px 10px 100px; color: #979da2; font-size: 14px'> Authorisation <span style='color: #2a80b2; font-weight: bold'>$daid</span> has been updated and has replaced <span style='color: #2a80b2; font-weight: bold'>$olddaid</span> due to: <span style='color: #2a80b2; font-weight: bold'>$reason</span>. Your bookmarks have already been updated to reflect these changes. To see the updated record class, click the button below.
        </td>
      </tr>
      <tr>
        <td align='center' style='padding: 15px 0px 15px 0px'>
          <a href='$websitelocation/index.php?daid=$daid'>
            <input style='border: none; color: white; font-size: 14px; background: #484847; padding: 10px 50px 10px 50px' type='submit' value='See updated record class $daid'/>
          </a>
        </td>
      </tr>
      <tr>
